...
export default function UserInfos() {
  return (
    <div className='flex flex-col items-center justify-center text-left text-slate-300 text-lg w-5/6 rounded-3xl bg-slate-700 py-3 shadow-md shadow-black/70'>
      ...
      <button type="submit" className="w-1/2 mt-5 text-white bg-slate-600 hover:bg-slate-500 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Log Out</button>
