  ...
  return (
    <div className="inline-block text-sm leading-none rounded-full text-white border-slate-700 hover:text-slate-500">
      <Menu as="div" className="relative inline-block">
        <div>
          <Menu.Button className="inline-flex w-full justify-center rounded-full bg-slate-900 bg-opacity-20 text-sm font-medium text-white focus:outline-none">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} className="w-10 h-10 stroke-slate-600 hover:stroke-slate-400">
        ...
        >
          <Menu.Items className="absolute right-0 mt-3 w-56 origin-top-right divide-y divide-slate-600 rounded-md bg-slate-800/80 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-10 shadow-md shadow-black/70">
