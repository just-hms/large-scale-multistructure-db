            ...
            <div className='relative w-full lg:w-3/4 max-h-96 overflow-auto rounded-3xl shadow-md shadow-black/70'>
                    ...
                    <div className='flex justify-center'>
                      <div className='w-full lg:m-5 flex items-center justify-center rounded-full bg-slate-800 bg-opacity-60 backdrop-blur-lg drop-shadow-lg'>
                        <input
                          ...
                          form-control id="barberSearch" placeholder="Search" onChange={handleChange}
                        />
              ...
              <div className="p-3 bg-slate-800/80">
                ...
                <div key={account.id} className="w-full text-slate-200 my-4 px-2 flex flex-col items-center justify-start">
                    <div key={account.id+"container"} className=" flex flex-col bg-slate-600 items-center justify-start w-full rounded-lg">
